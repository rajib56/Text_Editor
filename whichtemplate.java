...
public class whichtemplate extends JFrame implements ActionListener
		{
			JFrame f;
		...
		f=new JFrame();
		f.setLayout(null);
		f.setContentPane(new JLabel (new ImageIcon("background.jpg")));
		login=new JButton(new ImageIcon("Resized-8F3AG.png"));
